...
export class StepFunctionsStack extends Construct {
    ...
    constructor(scope: Construct, id: string, props: StepFunctionsStackProps) {
        ...
        const aggregateEvalResultsFunction = new lambda.DockerImageFunction(this, 'AggregateEvalResultsFunction', {
            ...
            memorySize: 2048 // Increase memory size to handle numpy/sklearn
        });
        ...
        const aggregateResultsTask = new tasks.LambdaInvoke(this, 'Aggregate Results', {
            ...
            payload: stepfunctions.TaskInput.fromObject({
                ...
                // Don't perform live evaluation or retrieval evaluation in aggregate step
                // The evaluation was already done in the eval Lambda
            }),
            outputPath: '$.Payload',
            retryOnServiceExceptions: true,
        });
