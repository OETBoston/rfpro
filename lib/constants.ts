...
export const kendraIndexName = 'rfpro-test-index-hx'
// must be unique globally or the deployment will fail
export const cognitoDomainName = "rfpro-test-auth-hx"
...
export const OIDCIntegrationName = "Boston"
// this MUST be unique to your account
export const stackName = "rfpro-test-hx"